...
'pythonColumn0.20.out' using ($3*1.e2):($1*1.e-6) title 'flushing gas 20 wt%', \
'pythonColumn0.50.out' using ($3*1.e2):($1*1.e-6) title 'flushing gas 50 wt%', \
'pythonColumn0.90.out' using ($3*1.e2):($1*1.e-6) title 'flushing gas 90 wt%', \
'pythonColumn1.10.out' using ($3*1.e2):($1*1.e-6) title 'flushing gas 110 wt%', \
'pythonColumn1.50.out' using ($3*1.e2):($1*1.e-6) title 'flushing gas 150 wt%'
...
'pythonColumn0.20.out' using ($4*1.e2):($1*1.e-6) title 'flushing gas 20 wt%', \
'pythonColumn0.50.out' using ($4*1.e2):($1*1.e-6) title 'flushing gas 50 wt%', \
'pythonColumn0.90.out' using ($4*1.e2):($1*1.e-6) title 'flushing gas 90 wt%'
...
'pythonColumn0.90.out' using ($5*1.e2):($1*1.e-6) title 'flushing gas 90 wt%', \
'pythonColumn1.10.out' using ($5*1.e2):($1*1.e-6) title 'flushing gas 110 wt%', \
'pythonColumn2.00.out' using ($5*1.e2):($1*1.e-6) title 'flushing gas 200 wt%'
...
'pythonColumn0.20.out' using ($6*1.e2):($1*1.e-6) title 'flushing gas 20 wt%', \
'pythonColumn0.50.out' using ($6*1.e2):($1*1.e-6) title 'flushing gas 50 wt%', \
'pythonColumn0.90.out' using ($6*1.e2):($1*1.e-6) title 'flushing gas 90 wt%', \
'pythonColumn1.10.out' using ($6*1.e2):($1*1.e-6) title 'flushing gas 110 wt%', \
'pythonColumn1.50.out' using ($6*1.e2):($1*1.e-6) title 'flushing gas 150 wt%'
...
'pythonColumn0.20.out' using ($7*1.e2):($1*1.e-6) title 'flushing gas 20 wt%', \
'pythonColumn0.50.out' using ($7*1.e2):($1*1.e-6) title 'flushing gas 50 wt%', \
'pythonColumn0.90.out' using ($7*1.e2):($1*1.e-6) title 'flushing gas 90 wt%', \
'pythonColumn1.10.out' using ($7*1.e2):($1*1.e-6) title 'flushing gas 110 wt%', \
'pythonColumn1.50.out' using ($7*1.e2):($1*1.e-6) title 'flushing gas 150 wt%'
...
'pythonColumn0.20.out' u 8:($1*1.e-6) title 'flushing gas 20 wt%', \
'pythonColumn0.50.out' u 8:($1*1.e-6) title 'flushing gas 50 wt%', \
'pythonColumn0.90.out' u 8:($1*1.e-6) title 'flushing gas 90 wt%', \
'pythonColumn1.00.out' u 8:($1*1.e-6) title 'flushing gas 100 wt%', \
'pythonColumn1.10.out' u 8:($1*1.e-6) title 'flushing gas 110 wt%', \
'pythonColumn1.50.out' u 8:($1*1.e-6) title 'flushing gas 150 wt%'
...
'pythonColumn0.10.out' u (1 - $8):($1*1.e-6) w lines lw 2 title 'flushing gas 10 wt%', \
'pythonColumn0.20.out' u (1 - $8):($1*1.e-6) w lines lw 2 title 'flushing gas 20 wt%', \
'pythonColumn0.50.out' u (1 - $8):($1*1.e-6) w lines lw 2 title 'flushing gas 50 wt%', \
'pythonColumn0.90.out' u (1 - $8):($1*1.e-6) w lines lw 2 title 'flushing gas 90 wt%', \
'pythonColumn1.10.out' u (1 - $8):($1*1.e-6) w lines lw 2 title 'flushing gas 110 wt%', \
'pythonColumn1.50.out' u (1 - $8):($1*1.e-6) w lines lw 2 title 'flushing gas 150 wt%'

set term qt 0
unset xrange
set xlabel 'Gas on total, wt%'
plot 'initialColumnPy.out' using ($9*1.e2):($1*1.e-6) w lines lw 2 title '', 'pythonColumn0.10.out' using ($9*1.e2):($1*1.e-6) w lines lw 2 title '', 'pythonColumn0.50.out' using ($9*1.e2):($1*1.e-6) w lines lw 2 title '', 'pythonColumn1.00.out' using ($9*1.e2):($1*1.e-6) w lines lw 2 title '', 'pythonColumn3.00.out' using ($9*1.e2):($1*1.e-6) w lines lw 2 title '', 'pythonColumn5.00.out' using ($9*1.e2):($1*1.e-6) w lines lw 2 title '', 'pythonColumn10.00.out' using ($9*1.e2):($1*1.e-6) w lines lw 2 title ''
...
'pythonColumn0.20.out' using (($4 - $6)*1.e2):($1*1.e-6) title 'flushing gas 20 wt%', \
'pythonColumn0.50.out' using (($4 - $6)*1.e2):($1*1.e-6) title 'flushing gas 50 wt%', \
'pythonColumn0.90.out' using (($4 - $6)*1.e2):($1*1.e-6) title 'flushing gas 90 wt%'
...
set yrange [0:7000]
plot 'initialColumnPy.out' u ($5*1.e2):($6*1.e6)  w lines lw 2 title 'initial condition', 'pythonColumn0.10.out' u ($5*1.e2):($6*1.e6)  w lines lw 2 title 'flushing gas 10 wt%', 'pythonColumn0.50.out' u ($5*1.e2):($6*1.e6)  w lines lw 2 title 'flushing gas 50 wt%', 'pythonColumn1.00.out' u ($5*1.e2):($6*1.e6)  w lines lw 2 title 'flushing gas 100 wt%', 'pythonColumn3.00.out' u ($5*1.e2):($6*1.e6)  w lines lw 2 title 'flushing gas 300 wt%', 'pythonColumn5.00.out' u ($5*1.e2):($6*1.e6)  w lines lw 2 title 'flushing gas 500 wt%', 'pythonColumn10.00.out' u ($5*1.e2):($6*1.e6)  w lines lw 2 title 'flushing gas 1000 wt%'