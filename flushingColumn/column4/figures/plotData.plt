...
set xlabel 'dissolved water, wt%'
set key bottom left
plot 'pythonColumn0.01.out' using ($5*1.e2):($1*1.e-6) w lines lw 2 title 'flushing gas 1 wt%', \
'pythonColumn0.02.out' using ($5*1.e2):($1*1.e-6) w lines lw 2 title 'flushing gas 2 wt%', \
'pythonColumn0.10.out' using ($5*1.e2):($1*1.e-6) w lines lw 2 title 'flushing gas 10 wt%', \
'pythonColumn0.90.out' using ($5*1.e2):($1*1.e-6) w lines lw 2 title 'flushing gas 90 wt%', \
'pythonColumn1.10.out' using ($5*1.e2):($1*1.e-6) w lines lw 2 title 'flushing gas 110 wt%', \
'pythonColumn2.00.out' using ($5*1.e2):($1*1.e-6) w lines lw 2 title 'flushing gas 200 wt%', \
...
'pythonColumn2.00.out' using (1 - $8):($1*1.e-6) w lines lw 2 title 'flushing gas 200 wt%', \
'pythonColumn3.00.out' using (1 - $8):($1*1.e-6) w lines lw 2 title 'flushing gas 300 wt%', \
'pythonColumn5.00.out' using (1 - $8):($1*1.e-6) w lines lw 2 title 'flushing gas 500 wt%', \
'pythonColumn10.00.out' using (1 - $8):($1*1.e-6) w lines lw 2 title 'flushing gas 1000 wt%'
